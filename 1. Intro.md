...
- Các vấn đề chủ yếu về an toàn thông tin
	...
	- Advance Persistent Threat : ( APT) : kỹ thuật tuấn công chủ yếu đánh cắp thông tin người dùng mà không có sự ảnh hưởng của người dùng
...
## 8. Network Security Zone

- Internet Zone : vùng ngoài tổ chức, không được tổ chức này quản lý ( vùng ISP )
- Internet DMZ :  vùng được quản lý, vùng đứng giữa internal networ và internet zone
- Production Zone : vùng hạn chế, khó quản lý được vùng này
- Intranet Zone :  vùng được quản lý, không được quản lý chán chế nhiều như DMZ
