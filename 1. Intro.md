...
- Những người có tấn công hệ thống được chia thành 8 loại
	...
	- Suiciden Hackers : 
	- Script Kiddies : có ít kiến thức về bảo mật, thực hiện theo các bài hướng dẫn . Có thể là giới "trẻ trâu". 
	- Cyber Terrorist :  tấn công các cuộc sống lớn. 
	- State Sponstoraed hacker : được thuê bởi chính phủ, bảo vệ các tài liệu mật
	- Hacktivists : thược hiện tuyên truyền các nội dung liên quan đến chính trị, văn hóa, xã hội , tấn công. các trạng thuộc chính thủ 
...
- Reconnasissance : thu nhập thông tin về đối tượng sẽ thực hiện tấn công. Càng nhiều thông tin thì khả năng tấn công càng nhau.
	- Passive : thu nhập thông tin nhưng không tương tác với hệ thống
	- Active : thu nhập thông tin thông qua việc tương tác với hệ thống, hoặc những người tương tác với hệ thống. 
...
- Gaining Access : sau khi tìm được "cửa " đi vào hệ thống. Sẽ truy cập vào hệ thống, truy xuất thông tin từ hệ thống
- Maintaning Acess or Backdoor  : xây dựng các đường hầm để có thể trở lại hệ thống trong tương lai
- Clearing Tracks : xóa dấu vết đã thực hiện trên hệ thống
...
- Các giao đoạn trong Ethical hacking
	- Footprinting & Reconnnasisance :
	- Scanning
	- Emmueration
	- System hacking
...
- Các pentester là người có quyền hack vào hệ thống bởi sự cho phép của người quản trị. 
...
- Các loại Penetration Testing
	- Black-Box : không được cung cấp truy cập vào hệ thống, và các thông tin về hệ thống
	- White-box :  được cung cấp quyền truy cập vào hệ thống, và các thông tin về hệ thống
	- Grey-box : được cung cấp một phần của hệ thống, và các thông tin về hệ thống. 
